...
export default function ZonelyLanding() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      {/* Navigation */}
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto h-[100px]">
      ...
      {/* Hero Section */}
      <header className="max-w-7xl mx-auto px-6 min-h-[calc(100vh-100px)] grid lg:grid-cols-2 gap-12 items-center pb-20">
        <div className="text-left flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#early-access" className="bg-indigo-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-indigo-700 transition shadow-lg text-center">
              Join the Free Early Access
            </a>
            <a href="#features" className="bg-white text-slate-700 border border-slate-200 px-8 py-4 rounded-full text-lg font-semibold hover:bg-slate-50 transition shadow-sm text-center">
              Explore Features
            </a>
          </div>
        </div>
      ...
      <section className="bg-slate-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-slate-300 leading-relaxed mb-8">
            Today’s mobile platforms treat every environment identically, whether you are in a lecture, a library, a gym, or at home. This uniformity drives severe digital distraction, reflexive device pickups, and notification fatigue. Existing solutions like rigid app time locks frequently fail because they impose prohibitive restrictions that are easily overridden.cite: 1]
          </p>
        </div>
      </section>
      ...
      <section id="features" className="py-24 max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Zonely replaces rigid digital blockades with intelligent adaptation using a custom geofencing engine to automatically transition your phone to fit your surroundings.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
            ...
            <p className="text-slate-600">
              Your data stays yours. Privacy is preserved through strictly on-device location calculations with zero raw GPS telemetry uploaded to cloud servers.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-slate-900 text-slate-400 py-8 text-center">
        <p>&copy; {new Date().getFullYear()} Zonely. Built with Flutter & Supabase.</p>
      </footer>
    </div>
  );
}